...
lambda_output <- as.data.frame(lambda_output)
sigma_2_output <- as.data.frame(sigma_2_output)
eta_output <- as.data.frame(eta_output)
phi_output <- as.data.frame(phi_output)
tau_output <- as.data.frame(tau_output)

view(colSums(lambda_output))
```
